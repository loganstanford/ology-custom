...
class Widget_OlogyBeersPostList extends Widget_Base {
...
public function get_title() {
    return esc_html__( 'Beers List - Ology', 'progression-elements-ontap' );
}
...
function Widget_OlogyBeersPostList($widget_instance){
...
protected function register_controls() {
    ...
    $this->add_responsive_control(
        'ology_beers_elements_image_grid_column_count',
        [
      ...
      $this->add_responsive_control(
          'ology__beers_elements_image_grid_margin',
          [
    ...
    $this->add_control(
        'ology_beers_elements_post_list_pagination',
        [
    ...
    $this->add_control(
        'ology_beers_main_post_load_more',
        [
    ...
    $this->add_control(
        'ology_beers_locs',
        [
            'label' => esc_html__( 'Narrow by Location', 'progression-elements-ontap' ),
            'description' => esc_html__( 'Choose a location', 'progression-elements-ontap' ),
            'label_block' => true,
            'multiple' => true,
            'type' => Controls_Manager::SELECT2,
            'options' => ology_elements_post_type_locations(),
        ]
    );

    $this->add_control(
        'ology_beers_post_order_sorting',
        [
    ...
    $this->add_control(
        'ology_beers_elements_post_order',
        [
    ...
    $this->add_control(
        'ology_beers_elements_post_sorting',
        [
    ...
    $this->add_control(
        'ology_beers_elements_post_filtering_text',
        [
            ...
            'conditions' => [
                'terms' => [
                    [
                        'name' => 'ology_beers_elements_post_sorting',
                        'operator' => '==',
                        'value' => 'yes',
                    ],
                ],
    ...
    $this->start_controls_section(
        'ology_beers_elements_section_main_styles',
        [
    ...
    $this->add_control(
        'ology_beers_elements_heading_title',
        [
    ...
    $this->add_control(
        'ology_beers_elements_traditional_title_color',
        [
    ...
    $this->add_control(
        'ology_beers_elements_traditional_title_color_hover',
        [
    ...
    $this->add_responsive_control(
        'ology_beers_elements_title_margin',
        [
    ...
    $this->add_control(
        'ology_beers_elements_heading_content',
        [
    ...
    $this->add_responsive_control(
        'ology_beers_elements_content_margin',
        [
    ...
    $this->add_control(
        'ology_beers_elements_traditional_border_color',
        [
    ...
    $this->add_control(
        'ology_beers_elements_traditional_content_color',
        [
    ...
    $this->add_responsive_control(
        'ology_beers_elements_post_meta_margin',
        [
    ...
    $this->add_control(
        'ology_beers_elements_traditional_meta_color',
        [
    ...
    $this->add_control(
        'ology_beers_elements_traditional_meta_color_hover',
        [
    ...
    $this->add_control(
        'ology_beers_elements_traditional_meta_background',
        [
    ...
    $this->add_control(
        'ology_beers_elements_traditional_metabutton_background_hover',
        [
    ...
    $this->add_responsive_control(
        'ology_beers_elements_load_more_margin',
        [
            'label' => esc_html__( 'Margin', 'progression-elements-ontap' ),
            'type' => Controls_Manager::DIMENSIONS,
            'size_units' => [ 'px', 'em', '%' ],
    ...
    $this->add_responsive_control(
        'ology_beers_elements_load_more_padding',
        [
    ...
    $this->add_control(
        'ology_beers_elements_filter_font_color',
        [
    ...
    $this->add_control(
        'ology_beers_elements_filter_font_selected_color',
        [
    ...
    $this->add_control(
        'ology_beers_elements_filter_font_selected_background',
        [
    ...
    $this->add_control(
        'ology_beers_elements_filter_border_color',
        [
    ...
    $this->add_responsive_control(
        'ology_beers_elements_fliltering_padding',
        [
            'label' => esc_html__( 'Padding', 'progression-elements-ontap' ),
            'type' => Controls_Manager::DIMENSIONS,
            'size_units' => [ 'px', 'em', '%' ],
    ...
    $this->add_responsive_control(
        'ology_beers_elements_fliltering_margin',
        [
            'label' => esc_html__( 'Margin', 'progression-elements-ontap' ),
            'type' => Controls_Manager::DIMENSIONS,
            'size_units' => [ 'px', 'em', '%' ],
...
$post_per_page = $settings['ology_beers_main_post_count'];
$offset = $settings['ology_beers_main_offset_count'];
$offset_new = $offset + (( $paged - 1 ) * $post_per_page);



if ( ! empty( $settings['ology_beers_post_cats'] ) ) {
    $formatarray = $settings['ology_beers_post_cats']; // get custom field value
    
    $catarray = $settings['ology_beers_post_cats']; // get custom field value
    if($catarray >= 1 ) { 
 ...
 if ( ! empty( $settings['ology_beers_locs'] ) ) {
    $beer_formatarray = $settings['ology_beers_locs']; // get custom field value
    
    $locarray = $settings['ology_beers_locs']; // get custom field value
    if($locarray >= 1 ) { 
        $locids = implode(', ', $locarray); 
    } else {
        $locids = '';
    }
    
    if($beer_formatarray >= 1) { 
        $beer_formatids = implode(', ', $beer_formatarray);
     $beer_formatidsexpand = explode(', ', $beer_formatids);
        $beer_formatoperator = 'IN'; 
    } else {
        $beer_formatidsexpand = '';
        $beer_formatoperator = 'NOT IN'; 
    }
    $beer_operator = 'IN';
 } else {

         $beer_formatidsexpand = '';
        $beer_operator = 'NOT IN';
 }

 $args = array(
         'post_type'         	=> 'beer_ontap',
          'orderby'         	=> $settings['ology_beers_elements_post_order_sorting'],
          'order'         		=> $settings['ology_beers_elements_post_order'],
          ...
          'tax_query' 			=> array(
               ...
               'field'    	=> 'slug',
               'terms'    	=> $beer_formatidsexpand,
               'operator' 	=> $beer_operator
               )
          ),
 );

 if ($settings['ology_beers_elements_post_order_sorting'] == "meta_value_num") {
    $args = array(
        'post_type'         	=> 'beer_ontap',
...
<?php if ( $settings['ology_beers_elements_post_sorting'] == 'yes' ) : ?>
    <div class="progression-filter-button-break-wide">
        <ul class="progression-filter-button-group ology-filter-group-<?php echo esc_attr($this->get_id()); ?>">
            <?php if($settings['ology_beers_post_cats']): ?>
                <?php
                    $i = 0;
...
<div class="progression-studios-elementor-post-container ology-beers-container">
<?php print_r($args);?>
    <div class="progression-masonry-margins">
        <div id="progression-beer-index-masonry-<?php echo esc_attr($this->get_id()); ?>">
            ...
            <div class="progression-masonry-item ><?php  $terms = get_the_terms( $post->ID , 'beer-category' );  if ( !empty( $terms ) ) : 	foreach ( $terms as $term ) { 	$term_link = get_term_link( $term, 'beer-category' ); if( is_wp_error( $term_link ) ) continue; echo " ". $term->slug ; }  endif; ?>
            "><!-- .progression-masonry-item -->
                <div class="progression-masonry-padding-blog">
                    <div class="progression-studios-isotope-animation">
                        
                            <?php include(locate_template('template-parts/elementor/content-beers.php')); ?>
    ...
    <div class="clearfix-pro"></div>
            ...
            <div class="ontap-progression-pagination-elementor">
                <?php if ( $settings['ology_beers_elements_post_list_pagination'] == 'default' ) : ?>
                    <?php
                ...
                <?php endif; ?>
                        ...
                        <?php if ( $settings['ology_beers_elements_post_list_pagination'] == 'load-more' ) : ?>
        
                            <?php $page_tot = ceil(($blogloop->found_posts - $offset) / $post_per_page); if ( $page_tot > 1 ) : ?>
                                <div id="progression-load-more-manual">
                                <div id="infinite-nav-pro-<?php echo esc_attr($this->get_id()); ?>" class="infinite-nav-pro"><div class="nav-previous"><?php next_posts_link( $settings['ology_main_post_load_more']
                . '<span><i class="fas fa-chevron-circle-down"></i></span>', $blogloop->max_num_pages ); ?></div></div>
                                </div>
                            <?php endif ?>
                        <?php endif; ?>

                        <?php if ( $settings['ology_beers_elements_post_list_pagination'] == 'infinite-scroll' ) : ?>
...
jQuery(document).ready(function($) {
    ...
    <?php endif ?>
      ...
      <?php if ( $settings['ology_beers_elements_post_list_pagination'] == 'infinite-scroll' || $settings['ology_beers_elements_post_list_pagination'] == 'load-more' ) : ?>
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_OlogyBeersPostList() );