	...
	<div class="progression-studios-elementor-post-container ology-spirits-container">
		...
		<div class="progression-masonry-margins">
			<div id="progression-beer-index-masonry-<?php echo esc_attr($this->get_id()); ?>">
				...
				<div class="progression-masonry-item ><?php  $terms = get_the_terms( $post->ID , 'spirit-category' );  if ( !empty( $terms ) ) : 	foreach ( $terms as $term ) { 	$term_link = get_term_link( $term, 'spirit-category' ); if( is_wp_error( $term_link ) ) continue; echo " ". $term->slug ; }  endif; ?>
