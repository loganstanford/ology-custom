...
function ology_toast_beer_metrics_shortcode()
{
    ...
    // Enqueue DataTables Buttons extension
    wp_enqueue_script('datatables-buttons', 'https://cdn.datatables.net/buttons/1.7.1/js/dataTables.buttons.min.js', array('jquery', 'datatables'), null, true);
    ...
    wp_enqueue_script('vfs_fonts', 'https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.1.53/vfs_fonts.js', array(), null, true);
    wp_enqueue_script('buttons-html5', 'https://cdn.datatables.net/buttons/1.7.1/js/buttons.html5.min.js', array('datatables-buttons'), null, true);
    wp_enqueue_script('buttons-print', 'https://cdn.datatables.net/buttons/1.7.1/js/buttons.print.min.js', array('datatables-buttons'), null, true);
...
jQuery(document).ready(function($) {
    ...
    var table = $('#ology-toast-beer-table').DataTable({
        ...
        buttons: [{
            ...
            title: 'OlogyToastBeerMetrics_<?php echo date('Y-m-d'); ?>'
        }]
    });
