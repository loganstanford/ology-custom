...
/**
 * Elementor Ology cocktails Widget.
 *
 * Elementor widget that inserts an embbedable content into the page, from any given URL.
 *
 * @since 1.0.0
 */
class Elementor_Ology_Cocktails_Widget extends \Elementor\Widget_Base
{

	/**
	 * Get widget name.
	 *
	 * Retrieve Ology cocktails widget name.
	 *
	 * @since 1.0.0
	 * @access public
	...
	{
		return 'Ology Cocktails';
	}

	/**
	 * Get widget title.
	 *
	 * Retrieve Ology cocktails widget title.
	 *
	 * @since 1.0.0
	 * @access public
	...
	{
		return esc_html__('Ology Cocktails', 'elementor-oembed-widget');
	}

	/**
	 * Get widget icon.
	 *
	 * Retrieve Ology cocktails widget icon.
	 *
	 * @since 1.0.0
	 * @access public
	 ...
	 *
	 * Retrieve the list of categories the Ology cocktails widget belongs to.
	 *
	 * @since 1.0.0
	 * @access public
	 ...
	 * Get widget keywords.
	 *
	 * Retrieve the list of keywords the Ology cocktails widget belongs to.
	 *
	 * @since 1.0.0
	 * @access public
	...
	{
		return ['ology-cocktails', 'url', 'link'];
	}

	/**
	 * Register Ology cocktails widget controls.
	 *
	...
	protected function register_controls()
	{
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Post Settings', 'elementor-ology-cocktails-widget'),
		...
		$this->add_control(
			$prefix . 'post_count',
			[
				'label' => esc_html__('Post Count', 'elementor-ology-cocktails-widget'),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__('Columns', 'elementor-ology-cocktails-widget'),
				'label_block' => true,
				...
				'mobile_default' => '100%',
				'options' => [
					'100%' => esc_html__('1 Column', 'elementor-ology-cocktails-widget'),
					'50%' => esc_html__('2 Column', 'elementor-ology-cocktails-widget'),
					'33.330%' => esc_html__('3 Columns', 'elementor-ology-cocktails-widget'),
					'25%' => esc_html__('4 Columns', 'elementor-ology-cocktails-widget'),
					'20%' => esc_html__('5 Columns', 'elementor-ology-cocktails-widget'),
					'16.67%' => esc_html__('6 Columns', 'elementor-ology-cocktails-widget'),
				],
				'selectors' => [
		...
		$this->add_responsive_control(
			$prefix . 'grid_margin',
			[
				'label' => esc_html__('Margin', 'elementor-ology-cocktails-widget'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Masonry Layout', 'elementor-ology-cocktails-widget'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Post Pagination', 'elementor-ology-cocktails-widget'),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'no-pagination',
				'options' => [
					'no-pagination' => esc_html__('No Pagination', 'elementor-ology-cocktails-widget'),
					'default' => esc_html__('Default Pagination', 'elementor-ology-cocktails-widget'),
					'load-more' => esc_html__('Load More Posts', 'elementor-ology-cocktails-widget'),
					'infinite-scroll' => esc_html__('Inifinite Scroll', 'elementor-ology-cocktails-widget'),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Load More Text', 'elementor-ology-cocktails-widget'),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Post Elements', 'elementor-ology-cocktails-widget')
			]
		);
		...
		$this->add_control(
			$prefix . 'image',
			[
				'label' => esc_html__('Display Image', 'elementor-ology-cocktails-widget'),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default' => 'yes',
			]
		...
		$this->add_control(
			$prefix . 'style',
			[
				'label' => esc_html__('Display Style', 'elementor-ology-cocktails-widget'),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default' => 'yes',
			]
		...
		$this->add_control(
			$prefix . 'features',
			[
				'label' => esc_html__('Display Features', 'elementor-ology-cocktails-widget'),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default' => 'yes',
			]
		...
		$this->add_control(
			$prefix . 'availability',
			[
				'label' => esc_html__('Display Availability', 'elementor-ology-cocktails-widget'),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default' => 'yes',
			]
		...
		$this->add_control(
			$prefix . 'excerpt',
			[
				'label' => esc_html__('Display Excerpt', 'elementor-ology-cocktails-widget'),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default' => 'yes',
			]
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Post Query', 'elementor-ology-cocktails-widget')
			]
		);
		...
		$this->add_control(
			$prefix . 'post_cats',
			[
				'label' => esc_html__('Narrow by Category', 'elementor-ology-cocktails-widget'),
				'description' => esc_html__('Choose a category to display cocktails', 'elementor-ology-cocktails-widget'),
				'label_block' => true,
				'multiple' => true,
				'type' => \Elementor\Controls_Manager::SELECT2,
				'options' => ology_cocktails_post_type_categories(),
			]
		);
		...
		$this->add_control(
			$prefix . 'post_styles',
			[
				'label' => esc_html__('Narrow by Ingredients', 'elementor-ology-cocktails-widget'),
				'description' => esc_html__('Choose an ingredient to display cocktails with those ingredients.', 'elementor-ology-cocktails-widget'),
				'label_block' => true,
				'multiple' => true,
				'type' => \Elementor\Controls_Manager::SELECT2,
				'options' => ology_cocktails_post_type_ingredients(),
			]
		);
		$this->add_control(
			$prefix . 'post_locations',
			[
				'label' => esc_html__('Narrow by Location', 'elementor-ology-cocktails-widget'),
				'description' => esc_html__('Choose a location to display cocktails from', 'elementor-ology-cocktails-widget'),
				'label_block' => true,
				'multiple' => false,
				'type' => \Elementor\Controls_Manager::SELECT2,
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Order By', 'elementor-ology-cocktails-widget'),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'date',
				'options' => [
					'date' => esc_html__('Default - Date', 'elementor-ology-cocktails-widget'),
					'title' => esc_html__('Post Title', 'elementor-ology-cocktails-widget'),
					'menu_order' => esc_html__('Menu Order', 'elementor-ology-cocktails-widget'),
					'modified' => esc_html__('Last Modified', 'elementor-ology-cocktails-widget'),
					'rand' => esc_html__('Random', 'elementor-ology-cocktails-widget'),
				],
			]
		);
		...
		$this->add_control(
			$prefix . 'post_order',
			[
				'label' => esc_html__('Order', 'elementor-ology-cocktails-widget'),
				'type' => \Elementor\Controls_Manager::SELECT,
				'default' => 'DESC',
				'options' => [
					'ASC' => esc_html__('Ascending', 'elementor-ology-cocktails-widget'),
					'DESC' => esc_html__('Descending', 'elementor-ology-cocktails-widget'),
				],
			]
		);
		...
		$this->add_control(
			$prefix . 'offset_count',
			[
				'label' => esc_html__('Offset Count', 'elementor-ology-cocktails-widget'),
				'type' => \Elementor\Controls_Manager::NUMBER,
				'default' => '0',
				'description' => esc_html__('Use this to skip over posts (Example: 3 would skip the first 3 posts.)', 'elementor-ology-cocktails-widget'),
			]
		);
		...
		$this->add_control(
			$prefix . 'post_sorting',
			[
				'label' => esc_html__('Category Sorting', 'elementor-ology-cocktails-widget'),
				'description' => esc_html__('Sort by Post Categories', 'elementor-ology-cocktails-widget'),
				'type' => \Elementor\Controls_Manager::SWITCHER,
				'return_value' => 'yes',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Sorting Text for "All Posts"', 'elementor-ology-cocktails-widget'),
				'type' => \Elementor\Controls_Manager::TEXT,
				'label_block' => true,
				'default' => esc_html__('All', 'elementor-ology-cocktails-widget'),
				'conditions' => [
					'terms' => [
						[
	...
	/**
	 * Render Ology cocktails widget output on the frontend.
	 *
	...
	protected function render()
	{
		...
		$cocktailsloop = new \WP_Query($args);
...
<div class="progression-filter-button-break-wide">
    <ul class="progression-filter-button-group progression-filter-group-<?php echo esc_attr($this->get_id()); ?>">
        ...
        <?php
						...
						$terms = get_terms('beer-category', $args_cats);
        ...
        <?php
						$i = 0;
						$terms = get_terms('beer-category', 'hide_empty=0');
						if (!empty($terms) && !is_wp_error($terms)) {
							echo '<li class="pro-checked" data-filter="*">' . $settings[$prefix . 'post_filtering_text'] . '</li> ';
...
<div class="progression-studios-elementor-post-container">
    <div class="progression-masonry-margins">
        <div id="progression-beer-index-masonry-<?php echo esc_attr($this->get_id()); ?>">
            <?php while ($cocktailsloop->have_posts()):
						$cocktailsloop->the_post(); ?>

            <div class="progression-masonry-item<?php $terms = get_the_terms($post->ID, 'beer-category');
						if (!empty($terms)):
							foreach ($terms as $term) {
								$term_link = get_term_link($term, 'beer-category');
                ...
                <div class="progression-masonry-padding-blog">
                    <div class="progression-studios-isotope-animation">
                        ...
                        <?php
									...
									include(locate_template('template-parts/elementor/content-cocktails-ology.php', false, true, $args_template)); ?>
    ...
    <div class="ontap-progression-pagination-elementor">
        ...
        <?php
					...
					$page_tot = ceil(($cocktailsloop->found_posts - $offset) / $post_per_page);
					...
					if ($page_tot > 1) {
						...
						echo paginate_links(array(
							...
							'format' => '?paged=%#%',
							'current' => max(1, $paged),
							'total' => ceil(($cocktailsloop->found_posts - $offset) / $post_per_page),
							'prev_next' => true,
        ...
        <?php $page_tot = ceil(($cocktailsloop->found_posts - $offset) / $post_per_page);
					if ($page_tot > 1): ?>
            ...
            <div id="infinite-nav-pro-<?php echo esc_attr($this->get_id()); ?>" class="infinite-nav-pro">
                <div class="nav-previous">
                    <?php next_posts_link($settings[$prefix . 'post_load_more']
										. '<span><i class="fas fa-chevron-circle-down"></i></span>', $cocktailsloop->max_num_pages); ?>
                </div>
            </div>
        </div>
        <?php endif ?>
        ...
        <div id="infinite-nav-pro-<?php echo esc_attr($this->get_id()); ?>" class="infinite-nav-pro">
            <div class="nav-previous">
                <?php next_posts_link('Next', $cocktailsloop->max_num_pages); ?>
            </div>
        </div>
        <?php endif ?>
        <?php endif; ?>
